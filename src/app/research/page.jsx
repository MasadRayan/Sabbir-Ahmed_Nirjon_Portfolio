      ...
      <main className="md:ml-80 md:w-[calc(100%-288px)]">
        <div className="md:pt-10 text-[#6B7770]">
          ...
          <div id="chakma" className="mb-10 scroll-mt-24 md:mt-20">
            ...
            <div className="flex flex-col md:flex-row gap-5 md:gap-10 justify-center items-start">
              <div className="md:w-1/2">
                <p className="text-lg mb-10">
                  Natural Language Processing (NLP) is one of the trending
                  topics in AI. Text classification, text completion, and
                  sentiment analysis have been carried out for various
                  languages, including English, Bengali, and Spanish. However,
                  there are still languages where the potential of NLP is
                  unexplored. The Chakma dialect, spoken by a significant ethnic
                  group in the Chittagong Hill Tracts of Bangladesh, is one such
                  area. This study makes a novel contribution by assessing
                  sentiment classification in the Chakma language for the first
                  time. A Chakma language dataset is formed by collecting some
                  frequently used texts from social media networks and Chakma
                  peers. It contains more than 8000 text samples with three
                  different labels: positive, negative, and neutral. To classify
                  this low-resource language effectively, several Bert-based
                  classifiers are fine-tuned and validated using accuracy
                  metrics and confusion metrics. Among the classifiers,
                  bert-base-uncased obtained 0.85 accuracy and 0.46 validation
                  loss, surpassing the others. This study will work as a pioneer
                  for other low-resource ethnic languages that are still
          ...
          <div id="sam" className=" scroll-mt-24">
            ...
            <p className="text-lg mb-10">
              Currently, I am analyzing the Segment Anything Model (SAM) to
              replace its traditional mask decoder with a dedicated LLM-based
              reasoning engine and introducing a multi-modal prompting strategy.
              This approach may shift the segmentation process from simple
              geometric matching to a high-level interpretive task, where the
              LLM decoder can process complex clinical narratives—such as
              specific radiological instructions or pathological context to
              resolve ambiguities in diffuse tumor boundaries. By integrating
              linguistic reasoning directly into the decoding phase, the model
              can adaptively refine masks for critical medical images like MRI,
              CT scan etc.
            </p>
          </div>
          ...
          <div id="camera" className="mb-10 scroll-mt-24">
            ...
            <p className="text-lg mb-10">
              Real-time monitoring and surveillance with Computer Vision is one
              of my current projects in collaboration of IIUC. I am guiding a
              group of students on project titled ESP-32 cam based robotic car
              surveillance and object detection with OpenCV and YOLOv26. Some
              extra features are to be added to fine-tune the current YOLO
              model. A comparison between YOLOv8, v11 and v26 will also be
              performed for making a robust result summary.
            </p>
            <div className="flex flex-col md:flex-row gap-5 justify-center items-start">
